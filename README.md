...
<div align="center">
  ...
  <br/>
  <h1><b>Blog App</b></h1><a name="about-project"></a>
</div>
...
> The site was built with Ruby on Rails and PSQL
...
```sh
  cd my-folder
  git clone https://github.com/Mar12358/blog-app.git
```
...
Feel free to check the [issues page](https://github.com/Mar12358/blog-app/issues).
