  ...
  describe 'Methods' do
    ...
    describe 'recent_comments Method' do
      it 'returns the five most recent comments' do
        comment1 = Comment.create(post: @post, author: @user, text: 'Hi Tom! 1', created_at: 7.day.ago )
        comment2 = Comment.create(post: @post, author: @user, text: 'Hi Tom! 2', created_at: 6.day.ago )
        comment3 = Comment.create(post: @post, author: @user, text: 'Hi Tom! 3', created_at: 5.day.ago )
