...
RSpec.describe User, type: :model do
  ...
  describe 'recent_posts Method' do
    it 'returns the three most recent posts' do
      ...
      user.save
      Post.create(author: user, title: 'Hello', text: 'This is my first post', created_at: 4.day.ago)
      Post.create(author: user, title: 'Hello', text: 'This is my second post', created_at: 3.day.ago)
